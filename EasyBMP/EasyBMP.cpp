...
bool BMP::ReadFromFile( const char* FileName )
{
 ...
 //cout << "BMFH: " << bmfh.bfType << " " << bmfh.bfSize << " " << bmfh.bfReserved1 << " " << bmfh.bfReserved2 << " " << bmfh.bfOffBits << endl;
 ...
 bmih.biHeight = (bmfh.bfSize-bmfh.bfOffBits)/bmih.biWidth/(bmih.biBitCount/8);
 //cout  << "First part of BMIH: "<< bmih.biSize << " " << bmih.biWidth << " " << bmih.biHeight << " " << bmih.biPlanes << " " << bmih.biBitCount << endl;
 ...
 //cout << "Second part of BMIH: " << bmih.biCompression << " " << bmih.biSizeImage << " " << bmih.biXPelsPerMeter << " " << bmih.biClrUsed << " " << bmih.biClrImportant << endl;
